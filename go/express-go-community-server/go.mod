module github.com/bitwomrhole-express/express/community-server

go 1.16

require (
	github.com/bitwormhole/starter v0.1.5 // direct
	github.com/bitwormhole/starter-gin v0.1.3 // direct
	github.com/bitwormhole/starter-gin-security v0.1.8 // direct
	github.com/bitwormhole/starter-gorm v0.0.7 // direct
