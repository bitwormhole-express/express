...
func autoGenConfig(cb application.ConfigBuilder) error {
	...
	// component: com8-impl0x31d227.AutoMigratorManager
	cominfobuilder.Next()
	cominfobuilder.ID("com8-impl0x31d227.AutoMigratorManager").Class("").Aliases("").Scope("")
	...
	// component: com10-security0xe21654.EmailAuthenticator
	cominfobuilder.Next()
	cominfobuilder.ID("com10-security0xe21654.EmailAuthenticator").Class("keeper-authenticator-registry").Aliases("").Scope("")
	...
	// component: com11-security0xe21654.PasswordAuthenticator
	cominfobuilder.Next()
	cominfobuilder.ID("com11-security0xe21654.PasswordAuthenticator").Class("keeper-authenticator-registry").Aliases("").Scope("")
	...
	// component: com12-interceptor0x488949.DebugInterceptor
	cominfobuilder.Next()
	cominfobuilder.ID("com12-interceptor0x488949.DebugInterceptor").Class("rest-interceptor-registry").Aliases("").Scope("")
	...
	// component: com13-controller0xc95f51.ExampleController
	cominfobuilder.Next()
	cominfobuilder.ID("com13-controller0xc95f51.ExampleController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com14-controller0xc95f51.AuthController
	cominfobuilder.Next()
	cominfobuilder.ID("com14-controller0xc95f51.AuthController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com15-controller0xc95f51.PasswordController
	cominfobuilder.Next()
	cominfobuilder.ID("com15-controller0xc95f51.PasswordController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com17-controller0xc95f51.EmailVerificationController
	cominfobuilder.Next()
	cominfobuilder.ID("com17-controller0xc95f51.EmailVerificationController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com18-controller0xc95f51.UploadController
	cominfobuilder.Next()
	cominfobuilder.ID("com18-controller0xc95f51.UploadController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com19-controller0xc95f51.BucketController
	cominfobuilder.Next()
	cominfobuilder.ID("com19-controller0xc95f51.BucketController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com20-controller0xc95f51.PackageController
	cominfobuilder.Next()
	cominfobuilder.ID("com20-controller0xc95f51.PackageController").Class("rest-controller").Aliases("").Scope("")
...
// comFactory4pComAutoMigratorManager : the factory of component: com8-impl0x31d227.AutoMigratorManager
...
func (inst * comFactory4pComAutoMigratorManager) getterForFieldDSSelector (context application.InstanceContext) datasource0x68a737.Source {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com8-impl0x31d227.AutoMigratorManager")
		eb.Set("field", "DS")
		eb.Set("type1", "?")
		eb.Set("type2", "datasource0x68a737.Source")
		context.HandleError(eb.Create())
...
// comFactory4pComEmailAuthenticator : the factory of component: com10-security0xe21654.EmailAuthenticator
...
func (inst * comFactory4pComEmailAuthenticator) getterForFieldAccountDAOSelector (context application.InstanceContext) dao0xf91732.Account {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com10-security0xe21654.EmailAuthenticator")
		eb.Set("field", "AccountDAO")
		eb.Set("type1", "?")
		eb.Set("type2", "dao0xf91732.Account")
		context.HandleError(eb.Create())
...
// comFactory4pComPasswordAuthenticator : the factory of component: com11-security0xe21654.PasswordAuthenticator
...
func (inst * comFactory4pComPasswordAuthenticator) getterForFieldAccountDAOSelector (context application.InstanceContext) dao0xf91732.Account {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com11-security0xe21654.PasswordAuthenticator")
		eb.Set("field", "AccountDAO")
		eb.Set("type1", "?")
		eb.Set("type2", "dao0xf91732.Account")
		context.HandleError(eb.Create())
...
// comFactory4pComDebugInterceptor : the factory of component: com12-interceptor0x488949.DebugInterceptor
...
// comFactory4pComExampleController : the factory of component: com13-controller0xc95f51.ExampleController
...
// comFactory4pComAuthController : the factory of component: com14-controller0xc95f51.AuthController
...
// comFactory4pComPasswordController : the factory of component: com15-controller0xc95f51.PasswordController
...
func (inst * comFactory4pComPasswordController) getterForFieldResponderSelector (context application.InstanceContext) glass0x47343f.MainResponder {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com15-controller0xc95f51.PasswordController")
...
// comFactory4pComEmailVerificationController : the factory of component: com17-controller0xc95f51.EmailVerificationController
...
func (inst * comFactory4pComEmailVerificationController) getterForFieldEmailVeriServiceSelector (context application.InstanceContext) service0x602df7.EmailVerificationService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com17-controller0xc95f51.EmailVerificationController")
		eb.Set("field", "EmailVeriService")
		eb.Set("type1", "?")
		eb.Set("type2", "service0x602df7.EmailVerificationService")
		context.HandleError(eb.Create())
...
// comFactory4pComUploadController : the factory of component: com18-controller0xc95f51.UploadController
...
func (inst * comFactory4pComUploadController) getterForFieldResponderSelector (context application.InstanceContext) glass0x47343f.MainResponder {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com18-controller0xc95f51.UploadController")
		eb.Set("field", "Responder")
		eb.Set("type1", "?")
		eb.Set("type2", "glass0x47343f.MainResponder")
		context.HandleError(eb.Create())
...
// comFactory4pComBucketController : the factory of component: com19-controller0xc95f51.BucketController
...
func (inst * comFactory4pComBucketController) getterForFieldResponderSelector (context application.InstanceContext) glass0x47343f.MainResponder {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com19-controller0xc95f51.BucketController")
		eb.Set("field", "Responder")
		eb.Set("type1", "?")
		eb.Set("type2", "glass0x47343f.MainResponder")
		context.HandleError(eb.Create())
...
// comFactory4pComPackageController : the factory of component: com20-controller0xc95f51.PackageController
...
func (inst * comFactory4pComPackageController) getterForFieldResponderSelector (context application.InstanceContext) glass0x47343f.MainResponder {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com20-controller0xc95f51.PackageController")
		eb.Set("field", "Responder")
		eb.Set("type1", "?")
		eb.Set("type2", "glass0x47343f.MainResponder")
		context.HandleError(eb.Create())
